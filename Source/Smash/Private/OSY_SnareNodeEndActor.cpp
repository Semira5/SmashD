...
// Sets default values
AOSY_SnareNodeEndActor::AOSY_SnareNodeEndActor()
{
...
void AOSY_SnareNodeEndActor::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AOSY_SnareNodeEndActor::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void AOSY_SnareNodeEndActor::OnComponentBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
