...
// Sets default values
AOSY_TomNodeEndActor::AOSY_TomNodeEndActor()
{
...
void AOSY_TomNodeEndActor::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AOSY_TomNodeEndActor::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void AOSY_TomNodeEndActor::OnComponentBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
